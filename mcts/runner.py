...
class Runner:
    def __init__(self, num_of_games=1, user_path='player.User', opponent_path=None):
    ...
    def run_game(self, tree_visualization=True):
        for i in range(self.num_of_games):
            ...
            self.user = getattr(importlib.import_module(module), name)(number_of_simulation=1000)
...
if __name__ == '__main__':
    runner = Runner(10, user_path='player.User', opponent_path=None)
    runner.run_game(tree_visualization=True)